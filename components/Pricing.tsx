...
const Pricing = () => {
  const plan = masterPlan[0]; // Accès direct au seul objet du tableau
  ...
  return (
    <section className="mb-32 flex flex-col items-center">
      ...
      <div className="bg-[#090f1f] w-full rounded-3xl p-20">
        <div className="max-w-[1200px] mx-auto flex items-center gap-10 text-white">
          <div className="w-1/2 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              <div className="">
                <h3 className="text-xl font-semibold uppercase">Highlights</h3>
                <p className="text-lg">
                  Everything you'll get from this package
                </p>
              </div>
